            ...
            if (!context.Drinks.Any())
            {
                context.Drinks.AddRange(
                    new Drink
                    {
                        ...
                        Img = "https://assets.iceland.co.uk/i/iceland/Coca_Cola_2lt_Classic_72577.jpg?$pdpzoom$",
                        Price = 23000,
                        Discount = 0,
                        Status = "Done",
                        CategoryID = 1
                    ...
                    new Drink
                    {
                        Name = "Pepsi",
                        Description = "Et in lobortis consetetur accusam ut ea diam ipsum consequat amet",
                        Img = "https://kvat-webassets.aisleahead.com/getMainImageSquare.php?upc=0001200059156&size=800&order=1",
                        Price = 20000,
                        Discount = 0,
                        Status = "Done",
                        CategoryID = 1
